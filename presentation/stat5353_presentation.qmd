...
svm_boruta_grid_opt %>%
  ...
  geom_boxplot() +
  labs(title = "SVM Overall Performance by Kernel",
       x = "Kernel",
       y = "MCC") +
  ggplot_my_theme
```
...
svm_boruta_grid_opt_gaussian %>%
  ...
  ggplot_my_theme +
  labs( 
    title = "Gaussian Kernel Hyperparameter Search",
    x = "c Value",
    y = "Epsilon",
    z = "MCC")
```
...
svm_boruta_grid_opt_linear %>%
  ...
  ggplot_my_theme +
  labs(
    title = "Linear Kernel Hyperparameter Search",
    x = "c Value (Positive)",
    y = "c Value (Negative)",
    z = "MCC")
```
...
svm_boruta_grid_opt_polynomial %>%
  ...
  ggplot_my_theme +
  labs(
    title = "Polynomial Kernel Hyperparameter Search",
    x = "c Value", 
